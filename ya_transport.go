...
func (t* YaTransport) RoundTrip(req *http.Request) (*http.Response, error) {
  if req.URL == nil {
    closeBody(req)
...
func (t *YaTransport) CloseIdleConnections() {
...
func (t *YaTransport) CancelRequest(req *http.Request) {
  t.reqMu.Lock()
...
func (t *YaTransport) sessionKeyForRequest(req *http.Request) (sessionKey, error) {
...
func (t *YaTransport) getRoundTripper(req *http.Request, sk sessionKey) (*roundTripper, error) {
...
func (t *YaTransport) getSession(req *http.Request, sk sessionKey) (*clientSession, error) {
  return t.findOrCreateConnectingSession(req, sk)
}

func (t *YaTransport) findAvailableSession(sk sessionKey) *clientSession {
...
func (t *YaTransport) setReqCanceler(r *http.Request, fn func()) {
  t.reqMu.Lock()
...
func (t *YaTransport) findOrCreateConnectingSession(req *http.Request, sk sessionKey) (*clientSession, error) {
...
func (t *YaTransport) makeSessionUnavailable(cs *clientSession) {
  t.sessMu.Lock()
  defer t.sessMu.Unlock()
  delete(t.availableSessions, cs.key)
}

func (t *YaTransport) createSessionForKey(sk sessionKey) (*clientSession, error) {
